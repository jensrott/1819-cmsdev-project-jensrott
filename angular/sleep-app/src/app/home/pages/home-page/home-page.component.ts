...
export class HomePageComponent implements OnInit {
  ...
  displaySleepStatus(): void {
    this.provideSleepResultsService.getCurrentSleepResults().subscribe(
      data => {
        // Get the most recent sleepresults from wordpress
        ...
        for (this.i = 0; this.i <= this.num; this.i++) {
          const day1 = moment(
            `${this.currentSleepResults[this.i].acf.day} ${
              this.currentSleepResults[this.i].acf.sleep_time
            } `,
          ...
          const day2 = moment(
            `${this.currentSleepResults[this.i].acf.day} ${
              this.currentSleepResults[this.i].acf.wake_up_time
            } `,
            "DD/MM/YYYY hh:mm A"
          ); // dayTime you woke up
        ...
        this.sleepGoalsService.getCurrentSleepGoal().subscribe(
          data1 => {
            ...
            const end_date = moment(
              `${this.currentSleepGoal[0].acf.end_date}`,
              "DD/MM/YYYY"
            );
            ...
            if (
              moment(end_date).isBefore(now) ||
              this.currentSleepGoal1 == null
            ) {
              // Add also check for non-existing SleepGoal
              setTimeout(() => this.showNoSleepGoal());
            } else {
              if (this.averageSleepResult >= this.currentSleepGoal1) {
                // If You sleep more or equal to your goals you made your sleep goal
  ...
  //       const day1 = moment(
  //         `${this.currentSleepResults[0].acf.day} ${
  //           this.currentSleepResults[0].acf.sleep_time
  //         } `,
  //         "DD/MM/YYYY hh:mm A"
  //       );
  //       console.log(day1);
  ...
  //       const day2 = moment(
  //         `${this.currentSleepResults[0].acf.day} ${
  //           this.currentSleepResults[0].acf.wake_up_time
  //         } `,
  //         "DD/MM/YYYY hh:mm A"
  //       );
  //       console.log(day2);
