...
export class QuizPageComponent implements OnInit {
  ...
  sendQuiz() {
    ...
    this.question1 = Array.from(document.querySelectorAll('input[name="question1"]'));
    this.question2 = Array.from(document.querySelectorAll('input[name="question2"]'));
    this.question3 = Array.from(document.querySelectorAll('input[name="question3"]'));
    this.question4 = Array.from(document.querySelectorAll('input[name="question4"]'));
    this.question5 = Array.from(document.querySelectorAll('input[name="question5"]'));
    this.question6 = Array.from(document.querySelectorAll('input[name="question6"]'));
    ...
    this.determineSleepType(this.answer1, this.answer2, this.answer3, this.answer4, this.answer5, this.answer6);
  }
  ...
  determineSleepType(answer1, answer2, answer3, answer4, answer5, answer6) {
    ...
    const morningPersonText = 'Jij bent een echt ochtendmens! `s ochtends sta je steeds lekker fris op en zou je de wereld kunnen overslaan';
    const sleepLoverText = 'Slapen is voor jouw het ultieme moment om te genieten. Sleep all day? Yes please!';
    const restlessBatText = 'Jij wou wel willen goed slapen, maar soms lukt het je echt niet... Je ligt nog lang wakker, te piekeren of te woelen';
    const screenAddictText = '’s avonds uren gamen, netflixen of instagrammen? Dat ben jij! Doordat je ’s avonds niet weg te slaan bent van de schermen, verlies je soms kostbare uren slaap. ';
    const pandaText = 'Geeuw… GEEEUWWW…. Geeuw… Moe in de klas? Moe in de zetel? Klinkt herkenbaar voor panda’s. Wat extra slaap kan je deugd doen! ';
    const sleepyHeadText = 'Ochtenden zijn zo je ding niet… Magische truc om ochtenden draaglijker te maken? Vroeger in bed kruipen!';
    const kingOfSleepText = 'Hé goed bezig! Jij vindt slaap belangrijk en probeert dit zo goed mogelijk te doen. Keep it up!';

    const morningPersonRoute = '../../../../../assets/images/morning_person.jpg';
