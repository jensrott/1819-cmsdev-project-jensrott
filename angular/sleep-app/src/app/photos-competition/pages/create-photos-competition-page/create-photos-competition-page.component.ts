...
export class CreatePhotosCompetitionPageComponent implements OnInit {
  ...
  constructor(
    private photoscompetitionService: PhotosCompetitionService,
  ...
  createPhotosCompetition() {
    ...
    this.photoscompetitionService.createPhoto(this.photo).subscribe(data => {
      ...
      this.photoscompetitionService
        .createPhotosCompetitionPostType(
          this.photo_competition.title,
          this.photo_competition.content
        )
        .subscribe(data1 => {
          ...
          this.photoscompetitionService
            .createPhotosCompetitionAcf(
              this.photo_competition_id,
              this.URL_photo
            )
            .subscribe(data2 => {
