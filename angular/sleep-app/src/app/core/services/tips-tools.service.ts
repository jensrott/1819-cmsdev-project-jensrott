...
export class TipsToolsService {
  ...
  private _apiAllTipsTools = environment.wpAPI.url + environment.wpAPI.endPoints.tips_tools;
  private _apiSpecificTipTool = environment.wpAPI.url + environment.wpAPI.endPoints.tips_tools;
  private _apiAddTipsTool = environment.wpAPI.url + environment.wpAPI.endPoints.tips_tools;
  ...
  addTipsTool(title, content): Observable<any> {
    ...
    return this._httpClient.post(`${this._apiAddTipsTool}`, this.object, httpOptions);
  }
